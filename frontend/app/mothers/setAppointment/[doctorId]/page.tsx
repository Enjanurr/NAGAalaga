    ...
    <main className="min-h-screen bg-[#F2EFF9] px-6 pt-20">
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <section>
          <div className="flex items-center gap-5 rounded-2xl bg-[#F2EFF9] p-7 shadow-md hover:-translate-y-0.5 hover:shadow-xl transition-all border border-[#3F2870]">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-extrabold text-[#3F2870]">{doctor.name}</h1>
              <p className="mt-1 text-sm text-[#3F2870] opacity-80">{doctor.hospital}</p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-2">
          <h2 className="text-xl font-semibold text-[#3F2870]">Select Date & Time</h2>
        ...
        {/* Reason Textarea */}
        <section className="space-y-2">
          <h2 className="text-xl font-semibold text-[#3F2870]">Reason for Appointment</h2>
          <textarea
            rows={4}
